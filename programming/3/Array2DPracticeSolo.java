 ...
 * Yanique Sears
 * collaborators: Kiana Herr, Jenna Lin, Nicole Cojuango
 */
...
public class Array2DPractice
{
  ...
  */
  ...
  {// traverses 2D Array
    for(int row =0; row< board.length; row++)
    {
      ...
      System.out.println(); // must be outside of the first brace
    }
  }
  ...
  */
  public static char[][] copyBoard( char[][] original )
  {
    ...
    for(int row =0; row <original.length; i++){
      for (int col =0; col<original [0].length; j++){
